           ...
           <div class="modal-body">
             <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>LRN</label>
                        <input id="edit_customer_email"  class="form-control" type="text" name="edit_customer_email" value="<?= $lrn ?>">
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>code</label>
                        <input id="edit_customer_email"  class="form-control" type="text" name="edit_customer_email" value="<?= $code ?>">
                    </div>
                </div>
             </div>
           </div>
...
<script>
    $(document).ready(function(){
        $("#editUserForm").submit(function(e){
            ...
            var cname = $("#edit_name").val();
            var cemail = $("#edit_email").val();
